    ...
    if(error) {
      ...
      callback('Unable to fetch whether');
        ...
        var returnObj = {
          ...
          satIcon: body.daily.data[0].icon,
          ...
          sunIcon: body.daily.data[1].icon,
          ...
          monIcon: body.daily.data[2].icon,
          ...
          tuesIcon: body.daily.data[3].icon,
          ...
          wedIcon: body.daily.data[4].icon,
          ...
          thurIcon: body.daily.data[5].icon,
          ...
          friIcon: body.daily.data[6].icon,
          friMaxTemp: (body.daily.data[6].temperatureHigh- 32)/1.8,
          friMinTemp: (body.daily.data[6].temperatureLow- 32)/1.8,
          friHumidity: body.daily.data[6].humidity * 100,
          friWindSpeed: body.daily.data[6].windSpeed,
          friPressure: body.daily.data[6].pressure,
          sat2Summary: body.daily.data[7].summary,
          sat2Icon: body.daily.data[7].icon,
          sat2MaxTemp: (body.daily.data[7].temperatureHigh- 32)/1.8,
          sat2MinTemp: (body.daily.data[7].temperatureLow- 32)/1.8,
          sat2Humidity: body.daily.data[7].humidity * 100,
          sat2WindSpeed: body.daily.data[7].windSpeed,
          sat2Pressure: body.daily.data[7].pressure
        };
