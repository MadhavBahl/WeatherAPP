    ...
    if(err) {
      ...
      if(errorMessage) {
        ...
        var weatherForecast = {
          ...
          currentPressure: (weatherResults.currentPressure/1000).toPrecision(7),
          weekSummary: weatherResults.weekSummary,
          sat: days[(dayNumber%7)],
          satSummary: weatherResults.satSummary,
          satIcon: weatherResults.satIcon,
          ...
          satPressure: (weatherResults.satPressure/1000).toPrecision(7),
          sun: days[(dayNumber+1)%7],
          sunSummary: weatherResults.sunSummary,
          sunIcon: weatherResults.sunIcon,
          ...
          sunPressure: (weatherResults.sunPressure/1000).toPrecision(7),
          mon: days[(dayNumber+2)%7],
          monSummary: weatherResults.monSummary,
          monIcon: weatherResults.monIcon,
          ...
          monPressure: (weatherResults.monPressure/1000).toPrecision(7),
          tues: days[(dayNumber+3)%7],
          tuesSummary: weatherResults.tuesSummary,
          tuesIcon: weatherResults.tuesIcon,
          ...
          tuesPressure: (weatherResults.tuesPressure/1000).toPrecision(7),
          wed: days[(dayNumber+4)%7],
          wedSummary: weatherResults.wedSummary,
          wedIcon: weatherResults.wedIcon,
          ...
          wedPressure: (weatherResults.wedPressure/1000).toPrecision(7),
          thur: days[(dayNumber+5)%7],
          thurSummary: weatherResults.thurSummary,
          thurIcon: weatherResults.thurIcon,
          ...
          thurPressure: (weatherResults.thurPressure/1000).toPrecision(7),
          fri: days[(dayNumber+6)%7],
          friSummary: weatherResults.friSummary,
          friIcon: weatherResults.friIcon,
          ...
          friPressure: (weatherResults.friPressure/1000).toPrecision(7),
          sat2: days[(dayNumber+7)%7],
          sat2Summary: weatherResults.sat2Summary,
          sat2Icon: weatherResults.sat2Icon,
          ...
          sat2Pressure: (weatherResults.sat2Pressure/1000).toPrecision(7)
        };
